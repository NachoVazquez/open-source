...
const renderStakeAddressCmd = (stakeAddressCmd: StakeAddressCmd) => {
  if (stakeAddressCmd as StakeAddressKeyGen) return 'stake-address key-gen';
  if (stakeAddressCmd as StakeAddressKeyHash) return 'stake-address key-hash';
  if (stakeAddressCmd as StakeAddressBuild) return 'stake-address build';
  if (stakeAddressCmd as StakeRegistrationCert) return 'stake-address registration-certificate';
